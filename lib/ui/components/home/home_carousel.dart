  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        ...
        const Padding(padding: EdgeInsetsDirectional.only(top: 8.0, start: 8.0), child: Text('Multi-browse layout')),
        ConstrainedBox(
        ...
        const SizedBox(height: 20),
        const Padding(padding: EdgeInsetsDirectional.only(top: 8.0, start: 8.0), child: Text('Uncontained layout')),
        ConstrainedBox(
          constraints: const BoxConstraints(maxHeight: 200),
          child: CarouselView(
            itemExtent: 330,
...
class UncontainedLayoutCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ColoredBox(
      color: Colors.primaries[index % Colors.primaries.length].withAlpha((0.5 * 255).toInt()),
      child: Center(
        child: Text(
          label,
